...
▝█▄█▌█  ▗▄█▄▖▝█▄█▌           ▝█▄▄▌  █▌▝█▄▄▌▐▙▄▝█▄▄▌
 ...
 ▜█▛▘                              █▌              
        ...
        while x < xmax:
            ...
            sql="TRUNCATE grid4326; INSERT INTO grid4326 SELECT (ST_GeomFromText('POLYGON  ',4326,{x} generate_series({starty},{endy},{ystep})  ".format(x=str(x),starty=starty,endy=endy)
            print sql
