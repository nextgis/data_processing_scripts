...
▝█▄█▌█  ▗▄█▄▖▝█▄█▌           ▝█▄▄▌  █▌▝█▄▄▌▐▙▄▝█▄▄▌
 ...
 ▜█▛▘                              █▌              
        ...
        while x < xmax:
            ...
            sql="TRUNCATE grid4326; INSERT INTO grid4326 SELECT (ST_GeomFromText('POLYGON  ',4326)), {xnum} AS x, generate_series({ynummin},{ynummax},{ystep})  ".format(xnum=str(xnum),ynummin=ynummin, ynummax=(totaly+ynummin), ystep=1 )
            print sql
            quit()
