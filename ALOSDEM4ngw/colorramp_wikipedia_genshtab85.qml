...
<qgis maxScale="0" minScale="1e+08" hasScaleBasedVisibilityFlag="0" version="3.24.0-Tisler" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" band="1" classificationMin="-28" type="singlebandpseudocolor" nodataColor="" alphaBand="-1" classificationMax="2921">
      ...
      <rastershader>
        <colorrampshader classificationMode="1" clip="0" colorRampType="INTERPOLATED" maximumValue="2921" minimumValue="-28" labelPrecision="0">
          ...
          <item value="-100" color="#85b6a3" alpha="255" label="-100 таки Израиль"/>
          <item value="-50" color="#85b6a3" alpha="255" label="-50 Астраханская низменость"/>
