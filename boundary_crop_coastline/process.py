...
▀▀▀▝▘▀▝▘▐▌▀▘  ▝▀▘ ▀     ▀▀    ▝▀▘  ▀▀▘ ▝▘ ▝▘     ▀▀ ▝▀▘    ▝▘   ▝▀▘  ▀▀▀   ▀▀  ▀▀ ▀▀▀ ▀▀▘ 
        ...
        cmd = 'ogr2ogr -progress -nlt multipolygon -overwrite -t_srs EPSG:4326 -f "PostgreSQL" PG:"{ogr2ogr_pg}" ../../simplifed/land_polygons_z5.shp -nln coastline'.format(ogr2ogr_pg=config.ogr2ogr_pg)
        print cmd        
        os.system(cmd)
...
▀▀▀▝▘▀▝▘▐▌▀▘  ▝▀▘ ▀     ▀▀    ▝▀▘  ▀▀▘ ▝▘ ▝▘     ▀▀ ▝▀▘    ▝▘   ▝▀▘  ▀▀▀   ▀▀  ▀▀ ▀▀▀ ▀▀▘ 
        ...
        cmd = 'ogr2ogr -progress -nlt multipolygon -overwrite -t_srs EPSG:4326 -f "ESRI Shapefile" boundary-polygon-cropped.shp  PG:"{ogr2ogr_pg}" "boundary_inner" '.format(ogr2ogr_pg=config.ogr2ogr_pg)
        print cmd        
        os.system(cmd)
