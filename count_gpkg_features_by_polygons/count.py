...
def argparser_prepare():
    ...
    parser.epilog = \
        '''Geojson boundaries should located in script directory: *.geojson
        Samples:
%(prog)s sample-features.gpkg sample-boundaries

Script use approx.geojson files if exist for speed optimitation
...
def process_region(boundary_filename=None, clip_straight=True, feature_num=0, boundary_geometry=None):
    ...
    if clip_straight:
        ...
        # quick spatial filter by envelope, then by boundary
